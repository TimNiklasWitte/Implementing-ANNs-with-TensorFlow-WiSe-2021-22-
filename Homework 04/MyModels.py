...
class MyModel_Regularization_L1(tf.keras.Model):
    def __init__(self):
        ...
        factor = 0.01
        self.dense1 = tf.keras.layers.Dense(128, activation=tf.nn.relu, kernel_regularizer=l1(factor), bias_regularizer=l1(factor))
        self.dense2 = tf.keras.layers.Dense(128, activation=tf.nn.relu, kernel_regularizer=l1(factor), bias_regularizer=l1(factor))
...
class MyModel_Regularization_L2(tf.keras.Model):
    def __init__(self):
        ...
        factor = 0.01
        self.dense1 = tf.keras.layers.Dense(128, activation=tf.nn.relu, kernel_regularizer=l2(factor), bias_regularizer=l2(factor))
        self.dense2 = tf.keras.layers.Dense(128, activation=tf.nn.relu, kernel_regularizer=l2(factor), bias_regularizer=l2(factor))
...
class MyModel_Regularization_L2_Dropout(tf.keras.Model):
    def __init__(self):
        super(MyModel_Regularization_L2_Dropout, self).__init__()
        factor = 0.01
        self.dense1 = tf.keras.layers.Dense(128, activation=tf.nn.relu, kernel_regularizer=l2(factor), bias_regularizer=l2(factor))
        self.dense2 = tf.keras.layers.Dense(128, activation=tf.nn.relu, kernel_regularizer=l2(factor), bias_regularizer=l2(factor))
        self.out = tf.keras.layers.Dense(1, activation=tf.nn.sigmoid, kernel_regularizer=l2(factor), bias_regularizer=l2(factor))
